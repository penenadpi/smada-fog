 ...
 * <!-- end-user-doc -->
 * @see smadafog.SmadafogPackage
 * @generated
 */
public class SmadafogSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static SmadafogPackage modelPackage;
	 ...
	 * @generated
	 */
	public SmadafogSwitch() {
		if (modelPackage == null) {
			modelPackage = SmadafogPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SmadafogPackage.CONTAINER: {
		...
		case SmadafogPackage.ALLOCATION: {
		...
		case SmadafogPackage.DEPLOYMENT: {
